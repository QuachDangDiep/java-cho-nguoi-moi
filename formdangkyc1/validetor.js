...
function Validator(options) {
    ...
    // Lấy elemrnt của form cần validate
...
// định nghia các rules
// Nguyên tắt của các rlus:
...
Validator.isConfirmed = function (selector, getConfirmValue, message){
    return {
        selector: selector,
        test: function (value){
            return value === getConfirmValue() ? undefined : message || 'Giá trị xác nhận không đúng';
        }
    }
}